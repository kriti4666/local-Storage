...
function myFunction() {
    ...
    studentAvatar.setAttribute("src", avatar)
    td1.append(studentAvatar);

    var td2 = document.createElement("td");
    var name = td2.innerText=name;
    ...
    var csMarks = td5.innerText=skillathon;

    var td6 = document.createElement("td");
    var codingMarks = td6.innerText=coding;
